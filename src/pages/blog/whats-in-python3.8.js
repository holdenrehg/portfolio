...
const meta = new Meta({
  ...
  description: `
    ...
    pipe.
  `,
  tags: "python,web development,software development,programming,programming languages",
  related: "chaining-context-managers-for-mocks,simple-business-manifesto,guide-to-erp",
})
...
const Page = props => (
  <Layout>
    <Article meta={props.meta}>
      ...
      <p>
        The programming language python is releasing it’s latest minor version
