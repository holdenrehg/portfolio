...
const meta = new Meta({
  id: "guide-to-no-bullshit-business-metrics",
  ...
  `,
  tags: "startup,business owner,entrepreneurship,business,metrics",
  related: "daily-odoo-team-routine,guide-to-erp,simple-business-manifesto",
})
...
const Page = props => (
  <Layout>
    <Article meta={props.meta}>
      ...
      <figure>
        <img src="/blog/guide-to-no-bullshit-business-metrics/metrics.jpeg"/>
      </figure>
