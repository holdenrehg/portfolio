...
const Page = props => (
  <Layout>
    <Article meta={props.meta}>
      <p>
        <span className="first-letter">T</span>he simplest possible definition
      ...
      <figure>
        <img src="/blog/guide-to-erp/infographic.png" alt=""/>
      </figure>
      ...
      <p>
        ...
        like the <a href="https://en.wikipedia.org/wiki/IBM_System/360" rel="noreferrer" target="_blank">IBM 360</a>
        which was larger than a refrigerator. MRP serves as the father of modern
        ERP.
      </p>
      <figure>
        <img src="/blog/guide-to-erp/ibm-360.jpg" alt=""/>
      ...
      <figure>
        <img src="/blog/guide-to-erp/r2.gif" alt=""/>
      ...
      <figure>
        <img src="/blog/guide-to-erp/iphone1.jpeg" alt=""/>
      ...
      <figure>
        <img src="/blog/guide-to-erp/erp-google-term.png" alt=""/>
      </figure>
      <p>
