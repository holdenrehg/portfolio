...
const meta = new Meta({
  ...
  `,
  tags: "odoo,python,productivity,web development,project management",
  related: "guide-to-no-bullshit-business-metrics,simple-business-manifesto,guide-to-erp",
})
...
const Page = props => (
  <Layout>
    <Article meta={props.meta}>
      <p>
        There are tons of these type of articles out on the internet. Articles
      ...
      <figure>
        <img src="/blog/daily-odoo-team-routine/slack.jpeg"/>
        <figcaption>
      ...
      {/* <figure name="bd74" id="bd74" class="graf graf--figure graf-after--p"><img class="graf-image" data-image-id="0*a8nfoXXbWTvNqLAa" data-width="4470" data-height="2980" data-unsplash-photo-id="OXkUz1Dp-4g" src="https://cdn-images-1.medium.com/max/800/0*a8nfoXXbWTvNqLAa">
      </figure> */}
      ...
      <p>
        ...
        <a href="https://github.com/OCA" target="_blank">OCA repositories</a>.
      </p>
      <p>
...
/client_a_addons
    ...
    __manifest__.py       # module dependency requirements
      ...
      <code className="console">
        <pre>{`
$ git clone git@bitbucket.org:bluestingray/project_a.git
$ cd project_a
$ ./make.sh
$ docker-compose up -d
