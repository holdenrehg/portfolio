...
export default new Meta({
    ...
    coverImage: '/images/articles/guide-to-no-bullshit-business-metrics/cover.jpg',
    thumbnailImage: '/images/articles/guide-to-no-bullshit-business-metrics/cover-min.jpg',
    description: 'Focusing on the right things in business, instead of getting distracted by random metrics.',
    contentSnippet: `
    <p>
      Businesses track horrible metrics
    ...
    <p>
      ...
      out there. I’m sure you see...
    </p>
    `,
    tags: [Tags.Business, Tags.SmallBusiness, Tags.Entrepreneurship],
    related: [
