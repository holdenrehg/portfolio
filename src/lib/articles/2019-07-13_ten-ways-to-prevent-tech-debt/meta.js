...
export default new Meta({
    ...
    coverImage: '/images/articles/ten-ways-to-prevent-tech-debt/cover.jpg',
    thumbnailImage: '/images/articles/ten-ways-to-prevent-tech-debt/cover-min.jpg',
    description:
        'Ways to cut down on risk with your software projects. Take more time now, fix less bugs later.',
    contentSnippet: `
    <p>
    ...
    `,
    tags: [Tags.WebDevelopment, Tags.Software, Tags.Python, Tags.OpenSource, Tags.SoftwareCraftsmanship],
    related: [
