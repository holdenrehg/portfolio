...
export default new Meta({
    ...
    coverImage: '/images/articles/odoo-sh-is-almost-ready/cover.jpeg',
    thumbnailImage: '/images/articles/odoo-sh-is-almost-ready/cover-min.jpg',
    description:
        "My thoughts about the early beta and development of Odoo.sh. I don't think it's quite ready for full time.",
    contentSnippet: `
    ...
    `,
    tags: [Tags.DevTools, Tags.Odoo, Tags.Python, Tags.Erp],
    related: [
