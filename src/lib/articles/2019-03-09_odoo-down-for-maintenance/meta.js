...
export default new Meta({
    ...
    coverImage: '/images/articles/odoo-down-for-maintenance/cover.jpg',
    thumbnailImage: '/images/articles/odoo-down-for-maintenance/cover-min.jpg',
    description:
        'Configuring a Down For Maintenance page can save a so much headache from customer complaints. I include one on every Odoo instance I configure.',
    contentSnippet: `
    ...
    `,
    tags: [Tags.Docker, Tags.Odoo, Tags.OpenSource, Tags.Erp, Tags.WebDevelopment],
    related: [
