...
export default new Meta({
    ...
    coverImage: '/images/articles/business-lessons-learned-from-chef-david-chang/cover.jpg',
    thumbnailImage: '/images/articles/business-lessons-learned-from-chef-david-chang/cover-min.jpg',
    description:
        "I've been a fan of cooking, cooking shows, and a handful of chefs for a long time. It wasn't until recently I realized there other lessons to learn from them too.",
    contentSnippet: `
    <p>I have been following David Chang and his work since about 2008, but I didn’t realize how much I’ve really learned from him, not about food, but about running a business until recently.</p>
    ...
    <p>Thanks Dave.</p>
    `,
    tags: [Tags.Entrepreneurship, Tags.SmallBusiness, Tags.BusinessStrategy],
    related: [
