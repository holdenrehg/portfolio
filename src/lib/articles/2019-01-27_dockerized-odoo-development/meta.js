...
export default new Meta({
    ...
    coverImage: '/images/articles/dockerized-odoo-development/cover.jpeg',
    thumbnailImage: '/images/articles/dockerized-odoo-development/cover-min.jpg',
    ...
    `,
    tags: [Tags.Odoo, Tags.Docker, Tags.Python, Tags.DevTools],
    related: [
