...
export default new Meta({
    ...
    coverImage: '/images/articles/odoo-tricks-and-tools/cover.jpg',
    thumbnailImage: '/images/articles/odoo-tricks-and-tools/cover-min.jpg',
    ...
    `,
    tags: [Tags.Python, Tags.Odoo, Tags.Erp, Tags.WebDevelopment],
    related: [
