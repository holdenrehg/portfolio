...
const Page = props => (
  <Layout>
    <Article meta={props.meta}>
      <p><span className="first-letter">I</span>n older versions of Odoo, prior to version 12.0, every instance was created with a default user called Administrator with a primary database id of 1.</p>
...
SUPERUSER_ID = 1
      ...
      <p>Developers who weren’t writing automated tests, never tested the system from the actual users point of view. This leads to lots of emails and complaints like “I clicked the Tasks menu and got an Access Denied error”.</p>
      ...
      <p>Don’t worry, there’s still that nice snippet in core that says <code>SUPERUSER = 1</code> but the default user, who is now called “Mitchell Admin”, has an id of 2.</p>
      <figure>
        <img src="/blog/becoming-a-superuser-in-odoo/metadata.png" alt=""/>
      </figure>
      <p>You don’t even have the ability to see a user with an id of 1 in the Settings &gt; Users list. It doesn’t seem to exist anymore from. Or it’s at least not accessible from the GUI.</p>
      ...
      <figure>
        <img src="/blog/becoming-a-superuser-in-odoo/debug-menu.png" alt=""/>
      </figure>

      {/* === */}

      <h2>With great power comes great responsibility</h2>
      <p>As a developer, you’ll want to use this with some caution. It’s easy to fall back into the trap of always being logged in as the superuser and ignoring all the permissions all of the time.</p>
