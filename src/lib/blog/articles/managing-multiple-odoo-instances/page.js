...
const Page = props => (
  <Layout>
    <Article meta={props.meta}>
      ...
      <p>
        This article will still have relevant information if you are running
        Odoo directly on your machine or server, but I recommend reading a
        more updated article
        like <a href="/blog/2019-01-27_dockerized-odoo-development">Easier Odoo Development</a> if
        you are in the position to containerize your application. — Holden
      </p>
      <hr/>
