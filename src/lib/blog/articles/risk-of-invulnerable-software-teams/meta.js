...
export default new Meta({
    ...
    coverImage: "/blog/risk-of-invulnerable-software-teams/cover.jpg",
    description: "There are risks as a software development team to being invulnerable and not handling feedback well.",
    contentSnippet: `
        <p>
        ...
        <p>
            ...
            the <a href="https://www.amazon.com/Peopleware-Productive-Projects-Teams-3rd/dp/0321934113" className="underline" target="_blank">Peopleware book</a>, take
            a look at <a href="https://rework.withgoogle.com/guides/managers-identify-what-makes-a-great-manager/steps/learn-about-googles-manager-research/" className="underline" target="_blank">Project Oxygen</a> or
            <a href="https://rework.withgoogle.com/print/guides/5721312655835136/" className="underline" target="_blank">Project Aristotle</a> by Google,
            learn about the <a href="https://www.youtube.com/watch?v=Q_bJVokYLRI" className="underline" target="_blank">BICEPS model</a> created by
            Paloma Medina, read about some
            of <a href="https://holub.com/blog/" className="underline" target="_blank">Allen Holub's work</a> on agile
